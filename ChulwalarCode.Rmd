...
```{r ExtractAndTransformToTimeSeries, echo = FALSE, eval=TRUE, results="hide", message=FALSE, warning=FALSE}
...
```{r echo=FALSE,eval=TRUE, fig.height=8, fig.width=4}
...
```{r timeseriesLinearModel, echo=FALSE}
TotalAsIs_tslm <- tslm(TotalAsIs ~ TotalPlan, data = TotalAsIs)
...
monthplot(EfakAsIs_stl$time.series[,"seasonal"], main="EfakAsIs_stl", ylab="Seasonal")
monthplot(WugeAsIs_stl$time.series[,"seasonal"], main="WugeAsIs_stl", ylab="Seasonal")
monthplot(TotalEtelAsIs_stl$time.series[,"seasonal"], main="TotalEtelAsIs_stl", ylab="Seasonal")
monthplot(BlueEtelAsIs_stl$time.series[,"seasonal"], main="BlueEtelAsIs_stl", ylab="Seasonal")
monthplot(RedEtelAsIs_stl$time.series[,"seasonal"], main="RedEtelAsIs_stl", ylab="Seasonal")
```
